	...
	<div class="pagetitle-container pagetitle-flexible-space" style="overflow: hidden;">
		...
		<div class="pagetitle-container pagetitle-align-right-container">
			...
			<? if(empty($arResult['IS_TRASH_MODE']))
				{
					?>
					<a class="ui-btn ui-btn-light-border ui-btn-themes js-disk-trashcan-button" href="<?= $arResult['PATH_TO_USER_TRASHCAN_LIST'] ?>" <?= ($isInIframe? 'target="_blank"' : '') ?>><?= Loc::getMessage('DISK_FOLDER_LIST_GO_TO_TRASH') ?></a>
					<?
				}
			?>
